...
function CopyableAddress({ address }: { address: string }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <a
        href={`https://smoothie.capital/?address=${address}`}
        target="_blank"
        ...
        {results.map((result) => (
          <TableRow key={result.userAddress}>
            ...
            <TableCell className="text-right font-mono text-sm text-green-600 dark:text-green-400">
              {result.supplyBalance.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </TableCell>
            <TableCell className="text-right font-mono text-sm text-blue-600 dark:text-blue-400">
              {result.collateralBalance.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </TableCell>
            <TableCell className="text-right font-mono text-sm text-red-600 dark:text-red-400">
              {result.debtBalance.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </TableCell>
          </TableRow>
        ))}
      </TableBody>
